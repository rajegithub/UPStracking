...
public class Envelope implements java.io.Serializable {
     ...
     */
    public void addBody(
            final com.ups.tracking.trackReply.Body vBody)
     ...
     * index
     */
    public com.ups.tracking.trackReply.Body getBody(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.ups.tracking.trackReply.Body) _body.get(index);
    }
    ...
    public com.ups.tracking.trackReply.Body[] getBody(
        ...
        com.ups.tracking.trackReply.Body[] array = new com.ups.tracking.trackReply.Body[0];
        return (com.ups.tracking.trackReply.Body[]) this._body.toArray(array);
    }
     ...
     */
    public com.ups.tracking.trackReply.Body removeBodyAt(
            final int index) {
        java.lang.Object obj = this._body.remove(index);
        return (com.ups.tracking.trackReply.Body) obj;
    }
     ...
     */
    public void setBody(
            final com.ups.tracking.trackReply.Body[] vBodyArray) {
        //-- copy array
        _body.clear();
	 ...
	 */
	public static com.ups.tracking.trackReply.Envelope unmarshal(
			final java.io.Reader reader)
					throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
		return (com.ups.tracking.trackReply.Envelope) Unmarshaller.unmarshal(com.ups.tracking.trackReply.Envelope.class, reader);
	}
